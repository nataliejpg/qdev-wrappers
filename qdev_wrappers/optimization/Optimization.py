...
from qdev_wrappers.optimization.methods import ReadoutFidelityOptimization
...
class Optimization:
    ...
    def __init__(self, method: ReadoutFidelityOptimization):
        ...
        self.best_cost_val = method.cost_val(initial_measurement)
    ...
    def optimize(self, *params):
        ...
        with meas.run() as datasaver:
            ...
            while not self.method.stopping_condition(self.num_attempts):
                ...
                print(f"Attempt {self.num_attempts} completed")
                self.num_attempts += 1
