    ...
    def update(self, settings: Dict):
        ...
        if self.dimensions == 1 and self._integrate_samples:
            ...
            self.prepare_channel(
                ...
                record_setpoint_label=settings['record_setpoint_label'],
                buffer_setpoint_label=settings['buffer_setpoint_label'],
                record_setpoint_unit=settings['record_setpoint_unit'],
                buffer_setpoint_unit=settings['buffer_setpoint_unit']
            )
